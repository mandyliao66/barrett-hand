...
"""autogenerated by genpy from bhand_controller/TactileArray.msg. Do not edit."""
import codecs
import sys
...
class TactileArray(genpy.Message):
  _md5sum = "c13cabdf3bf4be5ec7e27247c9867860"
  _type = "bhand_controller/TactileArray"
...
string frame_id
"""
  __slots__ = ['header','finger1','finger2','finger3','palm']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,finger1,finger2,finger3,palm
    ...
    """
    if args or kwds:
      super(TactileArray, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.finger1))
      length = len(self.finger2)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.finger2))
      length = len(self.finger3)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.finger3))
      length = len(self.palm)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.palm))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.finger1 = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.finger2 = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.finger3 = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.palm = s.unpack(str[start:end])
      return self
