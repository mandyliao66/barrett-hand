...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B2f().pack(_x.hand_initialized, _x.desired_freq, _x.real_freq))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      buff.write(_get_struct_2f().pack(*self.temp_f1))
      buff.write(_get_struct_2f().pack(*self.temp_f2))
      buff.write(_get_struct_2f().pack(*self.temp_f3))
      buff.write(_get_struct_2f().pack(*self.temp_spread))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.hand_initialized, _x.desired_freq, _x.real_freq,) = _get_struct_B2f().unpack(str[start:end])
      ...
      self.temp_f1 = _get_struct_2f().unpack(str[start:end])
      start = end
      end += 8
      self.temp_f2 = _get_struct_2f().unpack(str[start:end])
      start = end
      end += 8
      self.temp_f3 = _get_struct_2f().unpack(str[start:end])
      start = end
      end += 8
      self.temp_spread = _get_struct_2f().unpack(str[start:end])
      return self
