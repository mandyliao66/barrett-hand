...
bool operator==(const ::bhand_controller::State_<ContainerAllocator1> & lhs, const ::bhand_controller::State_<ContainerAllocator2> & rhs)
{
  return lhs.state == rhs.state &&
    lhs.control_mode == rhs.control_mode &&
    lhs.hand_initialized == rhs.hand_initialized &&
    lhs.desired_freq == rhs.desired_freq &&
    lhs.real_freq == rhs.real_freq &&
    lhs.state_description == rhs.state_description &&
    lhs.temp_f1 == rhs.temp_f1 &&
    lhs.temp_f2 == rhs.temp_f2 &&
    lhs.temp_f3 == rhs.temp_f3 &&
    lhs.temp_spread == rhs.temp_spread;
}
